...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'meraz.rahat@gmail.com' ")
...
message3 = tk.Label(window, text="                                    Attendence System Using Image Processing" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="red"  ,bg="#ea2a2a"  ,width=11 ,activebackground = "yellow" ,font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="red"  ,bg="#ea2a2a"  ,width=11 , activebackground = "yellow" ,font=('times', 11, ' bold '))
clearButton2.place(x=335, y=172)    
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages  ,fg="red"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="red"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
